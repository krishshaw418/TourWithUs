...
const Hotels = ()=>{
    ...
    <img src="https://media.istockphoto.com/id/119926339/photo/resort-swimming-pool.jpg?s=2048x2048&w=is&k=20&c=hKhLRUpl6c1p_6CdUHRLTAR-UEBdR6vml7M5AtCSCL4=" alt="" />
    <div className="card d-flex justify-content-center">
    <div className='row'>
        <div className='col-3'>
            
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas, cumque. Neque dicta modi ad veritatis voluptates laboriosam vero necessitatibus enim maxime ipsam, vel excepturi corporis?
        </div>
        <div className='col-9 d-flex justify-content-end'>
            <div className='minicards'>
            <div className='cardmini p-1'>
                <img src="" alt="error" />
            </div>
            <div className='cardmini p-1'>
                <img src="" alt="error" />
